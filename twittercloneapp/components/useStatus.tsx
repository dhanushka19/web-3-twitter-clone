...
import { STATUS_CONTRACT_ADDRESS } from '../constants/adresses';
				...
				<div className={styles.statusModalContainer}>
					<div className={styles.statusModal}>
						...
						<div className={styles.characterCountContainer}>
							<p className={characterDecoration}>
								{characterCount}/140
							</p>
						</div>
						<Web3Button
							...
							action={(contract) =>
								contract.call('setStatus', [newStatus])
							}
							isDisabled={
								characterCount === 0 || characterCount > 140
							}
							onSuccess={() => {
